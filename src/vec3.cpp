...
// Constructors
constexpr vec3::vec3() : e{ 0, 0, 0 } {}

constexpr vec3::vec3(const double e0, const double e1, const double e2) : e{ e0, e1, e2 } {}

[[nodiscard]] constexpr vec3 vec3::operator-() const { 
...
// Scalar assignments
constexpr vec3& vec3::operator*=(const double t) {
	e[0] *= t;
	e[1] *= t;
	e[2] *= t;
	return *this;
